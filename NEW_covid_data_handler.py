...
def process_covid_csv_data(covid_csv_data: list):
    ...
    # Consider using config.json to pull the strings from there instead
    # of leaving it as literals.
...
def finding_most_recent_datapoint(data: list, column_index: str):
...
def covid_API_request(location="Exeter", location_type="ltla"):
    ...
    # Consider using config.json to configure this
    csv_file_structure = \
        {
            "areaCode": "areaCode",
            "areaName": "areaName",
